...
def setCookie(url):
    ...
    requests.UserAgent = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) " \
...
class CNVD(object):
    def __init__(self, type_id):
        ...
        self.start_url = "https://www.cnvd.org.cn/flaw/typelist?typeId=" + self.type_id
        self.base_url = "https://www.cnvd.org.cn/flaw/typelist?typeId={}&max={}&offset={}"
    ...
    def get_max_page(self):
        ...
        pattern = html.xpath("//div[@class='pages clearfix']//a[last()-1]/text()")
        print(pattern)
        max_page = pattern[0]
        # print(max_page)
        if max_page:
